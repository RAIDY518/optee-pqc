...
#include <stdint.h>  /* include first so its include guard fires before poly.h; then undef clashing macros */
#undef L             /* OP-TEE stdint.h defines L(v) as a function-like macro; we need plain L=4 */
